...
bst_height(bst *tree)
{
  return _bst_node_height(tree->root) + 1;
}

bst_node *
bst_insert(bst *tree, int key)
{
...
{
  _bst_print_inorder_helper(tree->root);
}

bst_node *
bst_search(bst *tree, int key)
{
...
bst_node *
_bst_node_predecessor(bst_node *x)
{
  if (x == NULL)
    {
      return NULL;
...
bst_node *
_bst_node_successor(bst_node *x)
{
  if (x == NULL)
    {
      return NULL;
...
void
_bst_print_inorder_helper(bst_node *n)
{
  if (n == NULL)
    {
      return;
...
bst_node *
_bst_search_helper(bst_node *n, int key)
{
  if (n == NULL || n->key == key)
    {
      return n;
...
void
_bst_transplant(bst *tree, bst_node *u, bst_node *v)
{
  if (u->parent == NULL)
    {
      tree->root = v;
