...
int
cost_of_optimal_bst_memoized(int p[], int n)
{
...
int
cost_of_optimal_bst_memoized_aux(int **memo, int p[], int i, int j)
{
  if (i > j)
    {
      return 0;
...
int
cost_of_optimal_bst_naive(int p[], int n)
{
  return cost_of_optimal_bst_naive_aux(p, 0, n - 1);
}

int
cost_of_optimal_bst_naive_aux(int p[], int i, int j)
{
...
int
subarray_sum(int p[], int i, int j)
{
  int sum = 0;
